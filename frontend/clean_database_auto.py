"""
Clean Database Script - Auto version (no confirmation needed)
...
def clean_database():
    ...
    print("=" * 60)
    print("Database Cleanup Script (Auto Mode)")
    print("=" * 60)
    print()
    print("[DELETE] This will DELETE ALL DATA from:")
    ...
    try:
        ...
        for table, name in tables_to_clean:
            try:
                ...
                print(f"   [OK] {name}: Deleted {deleted:,} rows")
        ...
        # Verify cleanup
        print()
        print(f"[OK] Cleanup complete! Deleted {total_deleted:,} total rows")
        print()
        print("[SUCCESS] Database is now clean and ready for fresh data with Snov.io!")
